<template>
    <div class="myrow bottom_widget" style="display:block;margin-bottom:20px;">
        ...
        <div>
            <span style="display: block;text-align:center;" class="comment"
                >Sign up your friends to complete</span
            >
        </div>
